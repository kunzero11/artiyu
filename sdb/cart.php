...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
                <a class="nav-link px-2 order-now disabled" href="#">SHOP MENU</a>
            </li>
    ...
    <div class="row"> 
        <div class="col-md-8 cart"> 
            ...
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    <div class="col-2"><img class="img-fluid" src="https://i.ibb.co/31hyJ9d/beef.jpg"></div>
                    <div class="col">
                        <div class="row text-muted">Siomai</div>
                        <div class="row">Beef</div>
                    </div>
                    <div class="col"> <a href="#">-</a><a href="#" class="border">1</a><a href="#">+</a> </div>
                    <div class="col">&#8369; 50.00 <span class="close">&#10005;</span></div>
                </div>
            </div>
            <div class="row">
                <div class="row main align-items-center">
                    <div class="col-2"><img class="img-fluid" src="https://i.ibb.co/ZxqKSMC/chicken.jpg"></div>
                    <div class="col">
                        <div class="row text-muted">Siomai</div>
                        <div class="row">Chicken</div>
                    </div>
                    <div class="col"> <a href="#">-</a><a href="#" class="border">1</a><a href="#">+</a> </div>
                    <div class="col">&#8369; 45.00 <span class="close">&#10005;</span></div>
                </div>
            </div>
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    <div class="col-2"><img class="img-fluid" src="https://i.ibb.co/H2P86pM/pork-and-shrimp.jpg"></div>
                    <div class="col">
                        <div class="row text-muted">Siomai</div>
                        <div class="row">Pork & Shrimp</div>
                    </div>
                    <div class="col"> <a href="#">-</a><a href="#" class="border">1</a><a href="#">+</a> </div>
                    <div class="col">&#8369; 40.00 <span class="close">&#10005;</span></div>
                </div>
            </div>
            <div class="back-to-shop"><a href="homepage.php">&leftarrow;</a><span class="text-muted">Back to shop</span></div>
        </div>
        <div class="col-md-4 summary">
            ...
            <hr>
            <div class="row">
                <div class="col" style="padding-left:12px;"> <b>3 ITEM(S) </div>
            ...
            <form>
                ...
                <p><br> HAVE A GIFT CODE?</p> <input id="code" placeholder="Enter your code">
            </form>
            <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                <div class="col">TOTAL PRICE</div>
                <div class="col text-right">&#8369; 137.00</div>
            </div> <a href="checkout.php" class="btn btn-dark" role="button">CHECKOUT</a>
